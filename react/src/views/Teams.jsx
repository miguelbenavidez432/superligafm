                                            ...
                                            <td className="px-6 py-4 font-medium text-gray-300">
                                                {t.user ? (
                                                    <div className="flex items-center gap-3 flex-wrap">
                                                        ...
                                                        {t.user.discord_user?.discord_id ? (
                                                            <a
                                                                href={getDiscordDmUrl(t.user.discord_user.discord_id)}
                                                                target="_blank"
                                                                rel="noopener noreferrer"
                                                                className="inline-flex items-center gap-1 px-2 py-1 rounded-md bg-indigo-600/80 hover:bg-indigo-500 text-white text-xs font-bold transition-colors"
                                                            >
                                                                Discord
                                                            </a>
                                                        ) : (
                                                            <span className="text-xs text-slate-500 italic">Sin Discord</span>
                                                        )}
                                                    </div>
                                                ) : (

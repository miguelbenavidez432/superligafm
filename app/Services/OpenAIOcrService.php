    ...
    private function buildPrompt(string $context, int $homeId, int $awayId): string
    {
        ...
        4. Cruza los nombres de la imagen con la LISTA OFICIAL de contexto. Devuelve el nombre exactamente como aparece en la lista oficial. Si un jugador de la lista oficial no aparece en la imagen, devuélvelo con rating 0 y goles 0.
          5. VALIDACIÓN FINAL OBLIGATORIA:
              ...
              - Devuelve la lista de todos los jugadores que aparecen en la imagen, incluso si no tienen eventos. Si un jugador no tiene rating visible, pon rating 0. Si no tiene goles visibles, pon goles 0. Incluir LISTA OFICIAL DE JUGADORES (CONTEXTO) en la respuesta aunque no aparezcan en la imagen, pero con rating 0 y goles 0. Esto es obligatorio para que el sistema pueda comparar la lista oficial con lo que realmente se ve en la imagen.
              - Deben estar incluidos TODOS los jugadores que aparecen en la imagen, incluso si no tienen eventos asociados. Si un jugador no tiene rating visible, asigna rating 0. Si no tiene goles visibles, asigna goles 0.
